...
public class WSValorSerieVO implements java.io.Serializable {
	...
	public synchronized boolean equals(Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = this.ano == other.getAno() && this.anoFim == other.getAnoFim() && this.bloqueado == other.isBloqueado() && this.bloqueioLiberado == other.isBloqueioLiberado() && this.dia == other.getDia() && this.diaFim == other.getDiaFim() && this.mes == other.getMes() && this.mesFim == other.getMesFim() && this.oid == other.getOid() && this.oidSerie == other.getOidSerie() && ((this.svalor == null && other.getSvalor() == null) || (this.svalor != null && this.svalor.equals(other.getSvalor()))) && ((this.valor == null && other.getValor() == null) || (this.valor != null && this.valor.equals(other.getValor())));
		__equalsCalc = null;
		return _equals;
	}
