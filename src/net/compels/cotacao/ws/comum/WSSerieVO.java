package net.compels.cotacao.ws.comum;
...
public class WSSerieVO implements java.io.Serializable {
	...
	public WSSerieVO(int anoFim, int anoInicio, String aviso, int diaFim, int diaInicio, boolean especial, String fonte, String fullName, String gestorProprietario, int mesFim, int mesInicio, String nomeAbreviado, String nomeCompleto, long oid, String periodicidade, String periodicidadeSigla, boolean possuiBloqueios, boolean publica, String shortName, WSValorSerieVO ultimoValor, String unidadePadrao, String unidadePadraoIngles, boolean valorDiaNaoUtil, WSValorSerieVO[] valores) {
		this.anoFim = anoFim;
	...
	public synchronized boolean equals(Object obj) {
		...
		__equalsCalc = obj;
		boolean _equals;
		_equals = this.anoFim == other.getAnoFim() && this.anoInicio == other.getAnoInicio() && ((this.aviso == null && other.getAviso() == null) || (this.aviso != null && this.aviso.equals(other.getAviso()))) && this.diaFim == other.getDiaFim() && this.diaInicio == other.getDiaInicio() && this.especial == other.isEspecial() && ((this.fonte == null && other.getFonte() == null) || (this.fonte != null && this.fonte.equals(other.getFonte()))) && ((this.fullName == null && other.getFullName() == null) || (this.fullName != null && this.fullName.equals(other.getFullName()))) && ((this.gestorProprietario == null && other.getGestorProprietario() == null) || (this.gestorProprietario != null && this.gestorProprietario.equals(other.getGestorProprietario()))) && this.mesFim == other.getMesFim() && this.mesInicio == other.getMesInicio() && ((this.nomeAbreviado == null && other.getNomeAbreviado() == null) || (this.nomeAbreviado != null && this.nomeAbreviado.equals(other.getNomeAbreviado()))) && ((this.nomeCompleto == null && other.getNomeCompleto() == null) || (this.nomeCompleto != null && this.nomeCompleto.equals(other.getNomeCompleto()))) && this.oid == other.getOid() && ((this.periodicidade == null && other.getPeriodicidade() == null) || (this.periodicidade != null && this.periodicidade.equals(other.getPeriodicidade()))) && ((this.periodicidadeSigla == null && other.getPeriodicidadeSigla() == null) || (this.periodicidadeSigla != null && this.periodicidadeSigla.equals(other.getPeriodicidadeSigla()))) && this.possuiBloqueios == other.isPossuiBloqueios() && this.publica == other.isPublica() && ((this.shortName == null && other.getShortName() == null) || (this.shortName != null && this.shortName.equals(other.getShortName()))) && ((this.ultimoValor == null && other.getUltimoValor() == null) || (this.ultimoValor != null && this.ultimoValor.equals(other.getUltimoValor()))) && ((this.unidadePadrao == null && other.getUnidadePadrao() == null) || (this.unidadePadrao != null && this.unidadePadrao.equals(other.getUnidadePadrao()))) && ((this.unidadePadraoIngles == null && other.getUnidadePadraoIngles() == null) || (this.unidadePadraoIngles != null && this.unidadePadraoIngles.equals(other.getUnidadePadraoIngles()))) && this.valorDiaNaoUtil == other.isValorDiaNaoUtil() && ((this.valores == null && other.getValores() == null) || (this.valores != null && java.util.Arrays.equals(this.valores, other.getValores())));
		__equalsCalc = null;
		return _equals;
	}
	...
	// Type metadata
	private static final org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(WSSerieVO.class, true);
